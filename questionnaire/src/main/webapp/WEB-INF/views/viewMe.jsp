...
<div class="container">
    <form class="form-horizontal custom-form" role="form">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control custom-input" id="firstname" placeholder="请输入名">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-1"></div>
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control custom-input" id="lastname" placeholder="请输入姓">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-1"></div>
