...
<div class="container">
    <form  method="post" class="form-horizontal custom-form" role="form">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control custom-input" id="firstname" name="lastName" placeholder="请输入姓">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-1"></div>
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control custom-input" id="lastname" name="firstName" placeholder="请输入名">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-1"></div>
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control custom-input" id="username" name="userName" placeholder="请输入用户名">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-1"></div>
            ...
            <div class="col-sm-6">
                <input type="password" class="form-control custom-input" id="password" name="password" placeholder="请输入密码">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-1"></div>
            ...
            <div class="col-sm-6">
                <input type="tel" class="form-control custom-input" id="telephone" name="pho" placeholder="请输入电话号码">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-1"></div>
